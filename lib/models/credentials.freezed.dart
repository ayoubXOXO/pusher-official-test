...
abstract class $CredentialsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, String? token, String? password, String? userId});
}
...
class _$_Credentials with DiagnosticableTreeMixin implements _Credentials {
  const _$_Credentials({this.name, this.token, this.password, this.userId});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Credentials(name: $name, token: $token, password: $password, userId: $userId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, token, password, userId);
...
abstract class _Credentials implements Credentials {
  const factory _Credentials(
      ...
      final String? token,
      final String? password,
      final String? userId}) = _$_Credentials;
